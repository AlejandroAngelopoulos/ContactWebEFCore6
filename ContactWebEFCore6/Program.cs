...
var connString = builder.Configuration.GetConnectionString("MyContactManager");
...
builder.Services.AddScoped<IContactsRepository, ContactsRepository>();builder.Services.AddScoped<IStatesRepository ,StatesRepository > ();
